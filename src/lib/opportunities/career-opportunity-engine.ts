...
export const DEMO_STUDENT_OPPORTUNITIES: StudentOpportunity[] = [
  ...
  {
    id: "opp-int-04",
    title: "EV Battery Pack Assembly & BMS Testing Intern",
    organization: "Kinetic Green E-Mobility Manufacturing",
    location: "Electronic Zone, MIDC Hingna, Nagpur, Maharashtra",
    localZone: "Hingna",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Diploma / ITI in Electrical, Electronics, or Automobile Engineering",
    requiredSkills: ["Lithium-Ion Cells", "Battery Management System (BMS)", "Multimeter Testing", "High Voltage Safety"],
    deadline: "2026-06-20",
    daysRemaining: 88,
    matchPercentage: 95,
    stipendOrBenefit: "₹13,500 / month + Free Canteen Meals + Industrial Safety Kit",
    description: "Hands-on experience in 2-wheeler and 3-wheeler lithium-ion battery pack assembly lines, cell balancing diagnostics, and thermal runaway bench testing.",
    whyYouMatch: "Your 80% score in Electric Circuits & Physics directly matches battery pack testing criteria.",
    documentsRequired: ["College Bonafide / Marksheet", "Aadhaar Card", "Bank Account Details"],
    commuteTransitInfo: "City Bus Route 11 from Sitabuldi to Hingna Naka Gate 2",
    isDemo: true,
  },
  {
    id: "opp-int-05",
    title: "CNC Tooling & Precision Die Design Trainee Intern",
    organization: "Indo-German Tool Room (IGTR) Extension Centre",
    location: "Plot D-4, MIDC Hingna, Nagpur, Maharashtra",
    localZone: "Hingna",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Diploma Mechanical / Production or ITI Machinist / Fitter",
    requiredSkills: ["AutoCAD / SolidWorks", "CNC G-Codes", "Micrometer & Vernier", "Blueprint Reading"],
    deadline: "2026-06-25",
    daysRemaining: 93,
    matchPercentage: 91,
    stipendOrBenefit: "₹12,000 / month + MSME Certified Skill Training Credential",
    description: "Work alongside tool design engineers creating injection moulds, press tools, and CNC milled components for automotive clients across Vidarbha.",
    whyYouMatch: "High mechanics score (80%) and strong workshop precision record.",
    documentsRequired: ["Educational Certificates", "Photo ID", "2 Passport Photos"],
    commuteTransitInfo: "Walking distance from Hingna T-Point Bus Depot",
    isDemo: true,
  },
  {
    id: "opp-int-06",
    title: "Agro-Tech IoT & Drip Irrigation Automation Intern",
    organization: "Jain Irrigation Systems & Vidarbha Agri-Tech Hub",
    location: "Survey 44, Hingna Industrial Corridor, Nagpur, Maharashtra",
    localZone: "Hingna",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Class 12 Vocational / Diploma in Electronics, Agriculture or Mechatronics",
    requiredSkills: ["Solenoid Valves", "Soil Moisture Sensors", "Relay Control Boards", "Field Wiring"],
    deadline: "2026-06-15",
    daysRemaining: 83,
    matchPercentage: 90,
    stipendOrBenefit: "₹11,000 / month + Travel Field Allowance for Farm Demonstrations",
    description: "Field and lab internship assembling smart sensor-driven micro-irrigation controller boxes and telemetry modules for citrus and cotton farmers.",
    whyYouMatch: "Strong foundation in electrical circuits and agricultural automation interest.",
    documentsRequired: ["College Recommendation", "Identity Proof", "Address Proof"],
    commuteTransitInfo: "Direct bus from Wadi Naka to Hingna Agro-Hub",
    isDemo: true,
  },
  {
    id: "opp-int-07",
    title: "Full-Stack Web & AI Applications Trainee Intern",
    organization: "Infosys Limited — MIHAN Development Center",
    location: "Infosys Campus, Multi-Modal Hub, MIHAN SEZ, Nagpur",
    localZone: "MIHAN",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Diploma Computer Engineering / BCA / B.Sc IT / B.E Freshers",
    requiredSkills: ["React / TypeScript", "Python / Node.js", "REST APIs", "Git Version Control"],
    deadline: "2026-06-30",
    daysRemaining: 98,
    matchPercentage: 89,
    stipendOrBenefit: "₹18,000 / month + Campus Gym & Recreation Access + Laptop",
    description: "6-month immersive software engineering internship contributing to cloud enterprise dashboards, internal automation bots, and data pipelines.",
    whyYouMatch: "Strong mathematics score (Algebra 82%) and verified computer programming basics.",
    documentsRequired: ["Resume with GitHub/Portfolio link", "Diploma/Degree Marksheets", "Govt ID"],
    commuteTransitInfo: "Dedicated Infosys employee feeder coach from Metro Khapri Station",
    isDemo: true,
  },
  {
    id: "opp-int-08",
    title: "Aerospace Wire Harness & Avionics Assembly Intern",
    organization: "Dassault Reliance Aerospace Limited (DRAL)",
    location: "Dassault Falcon Hangar, Aviation Park, MIHAN SEZ, Nagpur",
    localZone: "MIHAN",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "ITI Electrician / Wireman / Electronics Mechanic or Diploma EE/ECE",
    requiredSkills: ["Aviation Wire Looming", "Crimping Tools", "ESD Protocols", "Multimeter Continuity"],
    deadline: "2026-06-05",
    daysRemaining: 73,
    matchPercentage: 96,
    stipendOrBenefit: "₹15,000 / month + Aerospace Standard ISO 9100 Training Certificate",
    description: "Work under certified master aeronautical technicians fabricating precision electrical harnesses and cockpit console looms for global commercial aircraft.",
    whyYouMatch: "Top 94% fit score: 80% circuit analysis and workshop safety alignment.",
    documentsRequired: ["Police Clearance Certificate (Aviation mandatory)", "Trade Marksheet", "Aadhaar Card"],
    commuteTransitInfo: "Security shuttle picks up from Airport South Metro Station",
    isDemo: true,
  },
  {
    id: "opp-int-09",
    title: "Data Center Cooling & Power Management Intern",
    organization: "CtrlS Datacenters MIHAN Edge Campus",
    location: "Plot 14, IT Special Economic Zone, MIHAN, Nagpur",
    localZone: "MIHAN",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Diploma in Electrical or Mechanical Engineering",
    requiredSkills: ["UPS Systems", "Diesel Generators", "HVAC Chiller Monitoring", "Single Line Diagrams"],
    deadline: "2026-06-18",
    daysRemaining: 86,
    matchPercentage: 91,
    stipendOrBenefit: "₹14,500 / month + Subsidized Cafeteria + Safety Gear",
    description: "Monitor tier-4 datacenter uninterruptible power supplies, dual-bus electrical switchboards, and chillers ensuring 99.999% cloud uptime.",
    whyYouMatch: "Circuit analysis mastery and high attendance reliability.",
    documentsRequired: ["Resume", "Diploma Sem Marksheets", "Photo ID"],
    commuteTransitInfo: "5 mins e-rickshaw from New Airport Metro Station",
    isDemo: true,
  },
  {
    id: "opp-int-10",
    title: "Industrial PLC & SCADA Process Control Intern",
    organization: "Morarjee Textiles Automation & Spinning Division",
    location: "Plot G-2, MIDC Butibori Industrial Zone, Nagpur, Maharashtra",
    localZone: "Butibori",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Diploma / ITI in Instrumentation, Electrical, or Mechatronics",
    requiredSkills: ["Ladder Logic", "Siemens / Allen Bradley PLC", "Sensor Calibrations", "Safety Relays"],
    deadline: "2026-06-12",
    daysRemaining: 80,
    matchPercentage: 93,
    stipendOrBenefit: "₹13,000 / month + Free Plant Bus from Sitabuldi & Wardha Road",
    description: "Assist automation engineers in programming and troubleshooting programmable logic controllers driving high-speed computerized textile spinning frames.",
    whyYouMatch: "High circuit diagnostics proficiency and logic readiness.",
    documentsRequired: ["College Bonafide Letter", "Identity Card", "Bank Account Passbook"],
    commuteTransitInfo: "Morarjee corporate bus stops at Butibori MIDC Gate 1",
    isDemo: true,
  },
  {
    id: "opp-int-11",
    title: "Solar PV Substation & Microgrid Commissioning Intern",
    organization: "Mahagenco Solar Energy Research Center",
    location: "Plot S-8, Butibori Renewable Corridor, Nagpur, Maharashtra",
    localZone: "Butibori",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Class 12 Vocational / ITI Electrician / Diploma Electrical",
    requiredSkills: ["Solar Panel String Testing", "Inverter Commissioning", "Earthing Pit Resistance", "DC Cabling"],
    deadline: "2026-06-22",
    daysRemaining: 90,
    matchPercentage: 94,
    stipendOrBenefit: "₹12,500 / month + Solar Rooftop Installation Certification",
    description: "Hands-on testing of utility-scale grid-tied solar inverters, module string voltage logging, and net metering synchronization.",
    whyYouMatch: "Excellent score in Electric Circuits (80%) and high regional green-energy demand.",
    documentsRequired: ["Trade Certificate / 12th Marksheet", "Aadhaar Card", "2 Photos"],
    commuteTransitInfo: "ST bus from Nagpur Central Bus Stand (Ganeshpeth) directly to Butibori",
    isDemo: true,
  },
  {
    id: "opp-int-12",
    title: "Pharmaceutical Cleanroom HVAC & Metrology Intern",
    organization: "Lupin Pharma Formulation Plant",
    location: "Plot 19-B, MIDC Butibori, Nagpur, Maharashtra",
    localZone: "Butibori",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Diploma in Mechanical, Electrical or Pharmacy / B.Sc",
    requiredSkills: ["HEPA Filtration Checks", "Temperature Data Logging", "Cleanroom Protocols (GMP)", "Calibration"],
    deadline: "2026-06-08",
    daysRemaining: 76,
    matchPercentage: 86,
    stipendOrBenefit: "₹13,500 / month + Uniform, Gowning Kit & Canteen Meals",
    description: "Gain practical exposure to WHO-GMP certified sterile pharmaceutical production lines, clean air handling units, and sensor calibration.",
    whyYouMatch: "High procedural compliance record (87% attendance) and math precision.",
    documentsRequired: ["College NOC", "Marksheets", "Medical Fitness Certificate"],
    commuteTransitInfo: "Company shuttle picks up from Butibori Flyover",
    isDemo: true,
  },
  {
    id: "opp-int-13",
    title: "Metro Rail Signalling & Telecommunication Trainee Intern",
    organization: "Maharashtra Metro Rail Corporation Limited (Maha Metro)",
    location: "Metro Bhavan, VIP Road, Near Dikshabhoomi, Nagpur",
    localZone: "Nagpur",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Diploma / Degree in Electronics & Telecommunication or Electrical",
    requiredSkills: ["CBTC Signalling Basics", "Optical Fiber Splicing", "Point Machine Testing", "Safety Interlocks"],
    deadline: "2026-06-28",
    daysRemaining: 96,
    matchPercentage: 92,
    stipendOrBenefit: "₹12,000 / month + Maha Metro Free Travel Pass for Duration",
    description: "Real-world exposure to Communication Based Train Control (CBTC) systems, automated fare collection gates, and trackside transponders.",
    whyYouMatch: "Circuit analysis, physics readiness, and Nagpur central transit convenience.",
    documentsRequired: ["College Bonafide", "Semester Marksheets", "Govt ID"],
    commuteTransitInfo: "Located right next to Rahate Colony Metro Station (Orange Line)",
    isDemo: true,
  },
  {
    id: "opp-int-14",
    title: "Junior Python Data Analytics & GIS Mapping Intern",
    organization: "Vidarbha Geoinformatics & Remote Sensing Center (VNIT Incubation)",
    location: "VNIT Campus, South Ambazari Road, Nagpur, Maharashtra",
    localZone: "Nagpur",
    category: "internships",
    categoryLabel: "Internships",
    categoryEmoji: "💼",
    eligibility: "Class 12 / Diploma / Undergraduate with Python & Math interest",
    requiredSkills: ["Python (Pandas / GeoPandas)", "QGIS Basics", "Data Cleaning", "Chart Visualization"],
    deadline: "2026-07-02",
    daysRemaining: 100,
    matchPercentage: 88,
    stipendOrBenefit: "₹15,000 / month + Co-authorship on Regional Environmental Datasets",
    description: "Analyze satellite imagery and groundwater maps of Vidarbha agricultural clusters using Python automation scripts and open-source GIS tools.",
    whyYouMatch: "High Algebra score (82%) and logical reasoning readiness.",
    documentsRequired: ["Resume", "Sample Code / Academic Projects", "Photo ID"],
    commuteTransitInfo: "Connected via Subhash Nagar and Shankar Nagar Metro Stations",
    isDemo: true,
  },
  ...
  {
    id: "opp-job-04",
    title: "EV Powertrain & Battery Field Service Technician",
    organization: "Mahindra Heavy Farm & E-Mobility Division",
    location: "Plot K-12, Sector 2, Hingna MIDC, Nagpur, Maharashtra",
    localZone: "Hingna",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "ITI Electrician / Motor Mechanic or Diploma Automobile / Electrical",
    requiredSkills: ["Brushless DC Motors", "CAN Bus Diagnostics", "Battery Testing", "Wiring Harness"],
    deadline: "2026-06-15",
    daysRemaining: 83,
    matchPercentage: 94,
    stipendOrBenefit: "₹2,60,000 – ₹3,10,000 / annum + Travel Allowance + Health Cover",
    description: "Diagnose, repair, and commission commercial electric vehicle powertrains, high-voltage battery modules, and onboard chargers at Hingna plant and regional dealerships.",
    whyYouMatch: "Your 80% circuit analysis and vehicle mechanics readiness match OEM field technician specs.",
    documentsRequired: ["ITI/Diploma Marksheet", "Valid 2-Wheeler/4-Wheeler License", "Aadhaar Card"],
    commuteTransitInfo: "Plant bus service covers Hingna, Wadi, and Ambazari routes",
    isDemo: true,
  },
  {
    id: "opp-job-05",
    title: "CNC Machine Programmer & Operator (Turning & Milling)",
    organization: "Hingna Precision Tooling & Engineering Works",
    location: "Electronic Zone, Phase 1, Hingna MIDC, Nagpur, Maharashtra",
    localZone: "Hingna",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "ITI Machinist / Turner or Diploma Mechanical Engineering",
    requiredSkills: ["Fanuc / Siemens CNC Controllers", "G-Code / M-Code", "Dial Gauges & Verniers", "Tool Offsets"],
    deadline: "2026-06-25",
    daysRemaining: 93,
    matchPercentage: 91,
    stipendOrBenefit: "₹2,40,000 – ₹2,80,000 / annum + Production Incentive Bonus",
    description: "Operate 3-axis CNC vertical machining centers, set up tool offsets, load raw metal castings, and ensure sub-micron dimensional tolerance.",
    whyYouMatch: "Strong mechanical motion fundamentals (80%) and workshop math precision.",
    documentsRequired: ["NCVT Certificate / Diploma", "PAN Card", "Aadhaar Card", "Bank Passbook"],
    commuteTransitInfo: "ST bus stops 200m from factory gate on Hingna Main Road",
    isDemo: true,
  },
  {
    id: "opp-job-06",
    title: "Industrial Electrical Panel Wiring & Testing Specialist",
    organization: "Bajaj Steel Industries Limited (Hingna Plant)",
    location: "Plot C-1, MIDC Hingna Industrial Area, Nagpur, Maharashtra",
    localZone: "Hingna",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "ITI Electrician / Wireman with valid PWD supervisor/wireman permit",
    requiredSkills: ["Control Panel Layouts", "MCB / Contactor Wiring", "Ferrule Labeling", "Insulation Resistance (Megger)"],
    deadline: "2026-07-05",
    daysRemaining: 103,
    matchPercentage: 96,
    stipendOrBenefit: "₹2,50,000 – ₹3,00,000 / annum + PF + ESI + Annual Bonus",
    description: "Assemble and wire heavy industrial control panels, MCC/PCC switchboards, and variable frequency drive (VFD) starter cabinets for cotton ginning machinery.",
    whyYouMatch: "Direct 96% match: 80% score in electric circuits and hands-on wiring proficiency.",
    documentsRequired: ["Wireman License", "Trade Certificate", "Aadhaar Card", "Photos (3)"],
    commuteTransitInfo: "Company shuttle from Sitabuldi and Hingna T-Point",
    isDemo: true,
  },
  {
    id: "opp-job-07",
    title: "Junior Cloud Operations & Linux System Administrator",
    organization: "HCLTech MIHAN Global Delivery Center",
    location: "Campus Plot 2, IT SEZ, MIHAN, Nagpur, Maharashtra",
    localZone: "MIHAN",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "Diploma CS/IT or B.Sc Computer Science / BCA (Freshers eligible)",
    requiredSkills: ["Linux Terminal (Bash)", "AWS / Azure Cloud Basics", "Docker Containers", "DNS / DHCP Networking"],
    deadline: "2026-06-20",
    daysRemaining: 88,
    matchPercentage: 89,
    stipendOrBenefit: "₹3,20,000 – ₹3,60,000 / annum + Health Insurance + Free Transport",
    description: "Provide 24/7 level-1 cloud operations support, monitor Kubernetes clusters and virtual machines, and resolve automated alerts.",
    whyYouMatch: "High mathematical reasoning (82%) and verified computer programming basics.",
    documentsRequired: ["College Degree/Diploma Certificate", "Resume", "Govt ID Proof"],
    commuteTransitInfo: "HCLTech cabs pickup across Nagpur municipal limits",
    isDemo: true,
  },
  {
    id: "opp-job-08",
    title: "Aviation Structural Assembler & Quality Inspector",
    organization: "Air India Engineering Services Limited (AIESL Boeing Hangar)",
    location: "Air India MRO Complex, MIHAN SEZ, Nagpur, Maharashtra",
    localZone: "MIHAN",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "Diploma in Mechanical/Aeronautical or ITI Fitter / Machinist with min 50%",
    requiredSkills: ["Precision Riveting", "Torque Calibration", "Technical Drawing Interpretation", "Corrosion Prevention"],
    deadline: "2026-06-10",
    daysRemaining: 78,
    matchPercentage: 92,
    stipendOrBenefit: "₹2,90,000 – ₹3,40,000 / annum + Aviation Hazard Insurance + Uniform",
    description: "Perform structural maintenance, sheet metal fabrication, and fastener replacement on commercial Boeing 737 and 777 aircraft during major C and D checks.",
    whyYouMatch: "Mechanics and motion readiness (80%) and high attendance discipline (87%).",
    documentsRequired: ["Aviation Security Background Verification Form", "All Marksheets", "Aadhaar Card"],
    commuteTransitInfo: "Air India employee coach from MIHAN Gate 1 (Khapri Metro)",
    isDemo: true,
  },
  {
    id: "opp-job-09",
    title: "Tier-1 Cyber Security Operations Center (SOC) Analyst",
    organization: "Persistent Systems MIHAN Cyber Hub",
    location: "Plot 1, IT Park, MIHAN SEZ, Nagpur, Maharashtra",
    localZone: "MIHAN",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "Diploma in Computer / Cyber Tech or BCA / B.Sc IT with network security exposure",
    requiredSkills: ["SIEM Log Analysis (Splunk / Elastic)", "Firewall Rules", "Phishing Investigation", "Network Protocols"],
    deadline: "2026-07-10",
    daysRemaining: 108,
    matchPercentage: 87,
    stipendOrBenefit: "₹3,40,000 – ₹3,80,000 / annum + Shift Allowance + Certifications Fund",
    description: "Monitor real-time cyber security events, detect malicious traffic anomalies, and triage incident alerts for international enterprise clients.",
    whyYouMatch: "Analytical math competence and methodical diagnostic reasoning.",
    documentsRequired: ["Resume", "Final Year Marksheet", "Valid Photo ID"],
    commuteTransitInfo: "Direct shuttle from Airport South Metro Station",
    isDemo: true,
  },
  {
    id: "opp-job-10",
    title: "Automated Packaging Line Maintenance Specialist",
    organization: "Haldiram's International Mega Food Processing Hub",
    location: "Phase 1, MIDC Butibori Industrial Area, Nagpur, Maharashtra",
    localZone: "Butibori",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "ITI Electrician / Fitter / Mechatronics or Diploma Mechanical/Electrical",
    requiredSkills: ["Pneumatic Cylinders", "Form-Fill-Seal Machines", "Conveyor Belt Drives", "Sensor Calibration"],
    deadline: "2026-06-18",
    daysRemaining: 86,
    matchPercentage: 93,
    stipendOrBenefit: "₹2,50,000 – ₹2,90,000 / annum + Subsidized Canteen Meals + Medical Insurance",
    description: "Maintain and troubleshoot high-speed automated vertical form-fill-seal packaging machinery, optical checkweighers, and palletizers running continuous shifts.",
    whyYouMatch: "High mechanics readiness (80%) and hands-on industrial machine wiring alignment.",
    documentsRequired: ["ITI/Diploma Marksheet", "Aadhaar Card", "2 Passport Photos", "Medical Fitness Certificate"],
    commuteTransitInfo: "Haldiram staff bus connects all stops from Zero Mile Nagpur to Butibori",
    isDemo: true,
  },
  {
    id: "opp-job-11",
    title: "High-Voltage Switchgear & Transformer Testing Technician",
    organization: "Schneider Electric & Vidarbha Power Ancillary Unit",
    location: "Plot E-14, MIDC Butibori, Nagpur, Maharashtra",
    localZone: "Butibori",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "ITI Electrician / Wireman or Diploma in Electrical Engineering",
    requiredSkills: ["SF6 Gas Circuit Breakers", "CT/PT Ratio Testing", "Transformer Oil BDV Test", "Safety Lockout/Tagout"],
    deadline: "2026-06-28",
    daysRemaining: 96,
    matchPercentage: 95,
    stipendOrBenefit: "₹2,60,000 – ₹3,10,000 / annum + Risk Allowance + Overtime Bonus",
    description: "Perform routine and breakdown testing on 11kV to 132kV medium/high voltage electrical switchboards, protective relays, and distribution transformers.",
    whyYouMatch: "Your 80% electric circuits score and multimeter diagnostics make you an ideal candidate.",
    documentsRequired: ["NCVT Certificate / Diploma", "Electrical License (if available)", "Aadhaar Card"],
    commuteTransitInfo: "Short 5-min walk from Butibori Police Station Bus Stop",
    isDemo: true,
  },
  {
    id: "opp-job-12",
    title: "Industrial Boiler & Steam Utility Plant Operator",
    organization: "Indo Rama Synthetics (India) Power & Utilities Division",
    location: "Plot A-1, MIDC Butibori Industrial Zone, Nagpur, Maharashtra",
    localZone: "Butibori",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "ITI Boiler Attendant / Fitter or Class 12 Science with technical diploma",
    requiredSkills: ["Boiler Water Chemistry", "Pressure Gauge Monitoring", "Steam Turbine Valves", "Safety Relief Systems"],
    deadline: "2026-07-02",
    daysRemaining: 100,
    matchPercentage: 88,
    stipendOrBenefit: "₹2,40,000 – ₹2,85,000 / annum + Quarters Accommodation Facility",
    description: "Operate fluidized bed combustion steam boilers and cooling towers supplying continuous high-pressure steam to polyester polymer production units.",
    whyYouMatch: "Strong foundation in applied mechanics, motion, and process discipline.",
    documentsRequired: ["Trade Certificate / Class 12 Marksheet", "Boiler Attendant Competency (if held)", "Aadhaar"],
    commuteTransitInfo: "Indo Rama bus leaves every morning from Sitabuldi & Chatrapati Square",
    isDemo: true,
  },
  {
    id: "opp-job-13",
    title: "Solar Rooftop Project Site Supervisor & Field Engineer",
    organization: "Nagpur Smart & Sustainable City Development Corporation (NSSCDCL)",
    location: "Civil Lines & Municipal Zones, Nagpur, Maharashtra",
    localZone: "Nagpur",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "Diploma in Electrical / Civil Engineering or ITI Electrician with 1 yr experience",
    requiredSkills: ["PV Module Stringing", "Grid Tie Inverter Hookup", "Net-Metering Approvals (MSEDCL)", "Site Safety Compliance"],
    deadline: "2026-06-22",
    daysRemaining: 90,
    matchPercentage: 94,
    stipendOrBenefit: "₹2,80,000 – ₹3,20,000 / annum + Fuel Allowance for Site Visits",
    description: "Supervise commercial and government rooftop solar PV installations across Nagpur, coordinate MSEDCL net metering inspections, and commission grid inverters.",
    whyYouMatch: "Top 94% fit: 80% circuit analysis readiness and Nagpur central location match.",
    documentsRequired: ["Diploma/Trade Certificate", "Driving License", "PAN Card", "Aadhaar Card"],
    commuteTransitInfo: "Office situated 5 mins walk from Kasturchand Park Metro Station",
    isDemo: true,
  },
  {
    id: "opp-job-14",
    title: "Fiber Optics & FTTH Broadband Network Field Engineer",
    organization: "Reliance Jio Infocomm Network Operations Center",
    location: "Dharampeth & West Nagpur Network Zone, Nagpur, Maharashtra",
    localZone: "Nagpur",
    category: "jobs",
    categoryLabel: "Jobs",
    categoryEmoji: "💻",
    eligibility: "ITI Wireman / Electronic Mechanic or Diploma in E&TC / Computer",
    requiredSkills: ["OTDR Fault Testing", "Optical Fiber Fusion Splicing", "Optical Power Meter", "GPON OLT / ONT Setup"],
    deadline: "2026-06-12",
    daysRemaining: 80,
    matchPercentage: 90,
    stipendOrBenefit: "₹2,30,000 – ₹2,70,000 / annum + Monthly Fuel Allowance + Mobile Recharges",
    description: "Deploy and maintain gigabit fiber-to-the-home (FTTH) connections, resolve optical fiber breaks using fusion splicers, and ensure ultra-low signal attenuation.",
    whyYouMatch: "Diagnostic circuit skills and spatial field navigation capability.",
    documentsRequired: ["Educational Certificates", "2-Wheeler Driving License", "Aadhaar Card"],
    commuteTransitInfo: "Near Shankar Nagar Square Metro Station (Aqua Line)",
    isDemo: true,
  },
